...
for irun in range(1, 2):
    ...
    for icase in range(1):
        ...
        config["Dataset"]["path"] = {}
        config["Dataset"]["path"]["train"] = "train_dataset/serialized_dataset/NiNb-trainset.pkl"
        config["Dataset"]["path"]["validate"] = "train_dataset/serialized_dataset/NiNb-valset.pkl"
        config["Dataset"]["path"]["test"] = "train_dataset/serialized_dataset/NiNb-testset.pkl"
        ...
        with open(pickle_dataset_path+"/NiNb-trainset.pkl", "rb") as f:
            _ = pickle.load(f)
